adjectives = input("... ").replace(' ','').split(',')
plural_nouns = input("Give me 3 plural nouns, separated by commas: ").replace(' ','').split(',')
nouns = input("Give me 4 nouns, separated by commas: ").replace(' ','').split(',')
